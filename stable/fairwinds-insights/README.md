...
| temporal.server.additionalEnv[0].name | string | `"SQL_PLUGIN"` |  |
| temporal.server.additionalEnv[0].value | string | `"postgres12"` |  |
| temporal.server.additionalEnv[1].name | string | `"SQL_HOST"` |  |
| temporal.server.additionalEnv[1].value | string | `"insights-postgresql"` |  |
| temporal.server.additionalEnv[2].name | string | `"SQL_PORT"` |  |
| temporal.server.additionalEnv[2].value | string | `"5432"` |  |
| temporal.server.additionalEnv[3].name | string | `"SQL_DATABASE"` |  |
| temporal.server.additionalEnv[3].value | string | `"temporal"` |  |
| temporal.server.additionalEnv[4].name | string | `"SQL_USER"` |  |
| temporal.server.additionalEnv[4].value | string | `"postgres"` |  |
| temporal.server.additionalEnv[5].name | string | `"SQL_PASSWORD"` |  |
| temporal.server.additionalEnv[5].valueFrom.secretKeyRef.name | string | `"fwinsights-postgresql"` |  |
| temporal.server.additionalEnv[5].valueFrom.secretKeyRef.key | string | `"postgresql-password"` |  |
| temporal.server.additionalEnv[6].name | string | `"SQL_TLS"` |  |
| temporal.server.additionalEnv[6].value | string | `"true"` |  |
| temporal.server.additionalEnv[7].name | string | `"SQL_TLS_CERT_FILE"` |  |
| temporal.server.additionalEnv[7].value | string | `"/etc/temporal/tls/tls.crt"` |  |
| temporal.server.additionalEnv[8].name | string | `"SQL_TLS_KEY_FILE"` |  |
| temporal.server.additionalEnv[8].value | string | `"/etc/temporal/tls/tls.key"` |  |
| temporal.server.additionalEnv[9].name | string | `"SQL_TLS_DISABLE_HOST_VERIFICATION"` |  |
| temporal.server.additionalEnv[9].value | string | `"true"` |  |
| temporal.server.additionalEnv[10].name | string | `"TEMPORAL_SQL_PLUGIN"` |  |
| temporal.server.additionalEnv[10].value | string | `"postgres12"` |  |
| temporal.server.additionalEnv[11].name | string | `"TEMPORAL_SQL_HOST"` |  |
| temporal.server.additionalEnv[11].value | string | `"insights-postgresql"` |  |
| temporal.server.additionalEnv[12].name | string | `"TEMPORAL_SQL_PORT"` |  |
| temporal.server.additionalEnv[12].value | string | `"5432"` |  |
| temporal.server.additionalEnv[13].name | string | `"TEMPORAL_SQL_DATABASE"` |  |
| temporal.server.additionalEnv[13].value | string | `"temporal"` |  |
| temporal.server.additionalEnv[14].name | string | `"TEMPORAL_SQL_USER"` |  |
| temporal.server.additionalEnv[14].value | string | `"postgres"` |  |
| temporal.server.additionalEnv[15].name | string | `"TEMPORAL_SQL_PASSWORD"` |  |
| temporal.server.additionalEnv[15].valueFrom.secretKeyRef.name | string | `"fwinsights-postgresql"` |  |
| temporal.server.additionalEnv[15].valueFrom.secretKeyRef.key | string | `"postgresql-password"` |  |
| temporal.server.additionalEnv[16].name | string | `"TEMPORAL_SQL_TLS"` |  |
| temporal.server.additionalEnv[16].value | string | `"true"` |  |
| temporal.server.additionalEnv[17].name | string | `"TEMPORAL_SQL_TLS_CERT_FILE"` |  |
| temporal.server.additionalEnv[17].value | string | `"/etc/temporal/tls/tls.crt"` |  |
| temporal.server.additionalEnv[18].name | string | `"TEMPORAL_SQL_TLS_KEY_FILE"` |  |
| temporal.server.additionalEnv[18].value | string | `"/etc/temporal/tls/tls.key"` |  |
| temporal.server.additionalEnv[19].name | string | `"TEMPORAL_SQL_TLS_DISABLE_HOST_VERIFICATION"` |  |
| temporal.server.additionalEnv[19].value | string | `"true"` |  |
