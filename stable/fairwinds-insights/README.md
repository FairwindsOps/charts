...
| postgresql.tls | object | `{"certFilename":"tls.crt","certKeyFilename":"tls.crt","certificatesSecret":"fwinsights-postgresql-ca","enabled":true}` | TLS mode for connecting to the database |
