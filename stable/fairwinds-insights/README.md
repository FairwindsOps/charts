...
| gcpPricing | object | `{"credentialsMountPath":"","credentialsSecretKey":"","credentialsSecretName":"","enabled":false,"externalSecret":{"annotations":{},"create":false,"data":[],"name":"","refreshInterval":"1h","secretStoreRef":{"kind":"ClusterSecretStore","name":"fairwinds-vault-backend"}},"projectID":""}` | GCP Cloud Billing / Compute pricing for UpdateGCPCloudPricingWorkflow (general-worker). |
| gcpPricing.projectID | string | `""` | GCP project for Compute machineTypes. Empty: omit GCP_PROJECT_ID (activity skips). Not used for ADC auth. |
| gcpPricing.credentialsSecretName | string | `""` | Secret with the GCP SA JSON. Empty: no mount, ADC without a file (DefaultTokenSource). |
