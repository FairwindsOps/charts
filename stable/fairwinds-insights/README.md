...
| temporal.server.additionalEnv[0].name | string | `"TEMPORAL_PG_TLS_CERT_FILE"` |  |
| temporal.server.additionalEnv[0].value | string | `"/etc/temporal/tls/tls.crt"` |  |
| temporal.server.additionalEnv[1].name | string | `"TEMPORAL_PG_TLS_KEY_FILE"` |  |
| temporal.server.additionalEnv[1].value | string | `"/etc/temporal/tls/tls.key"` |  |
| temporal.server.additionalEnv[2].name | string | `"TEMPORAL_PG_TLS_ENABLED"` |  |
| temporal.server.additionalEnv[2].value | string | `"true"` |  |
| temporal.server.additionalEnv[3].name | string | `"TEMPORAL_PG_TLS_DISABLE_HOST_VERIFICATION"` |  |
| temporal.server.additionalEnv[3].value | string | `"true"` |  |
| temporal.server.additionalEnv[4].name | string | `"TEMPORAL_POSTGRES_TLS_CERT_FILE"` |  |
| temporal.server.additionalEnv[4].value | string | `"/etc/temporal/tls/tls.crt"` |  |
| temporal.server.additionalEnv[5].name | string | `"TEMPORAL_POSTGRES_TLS_KEY_FILE"` |  |
| temporal.server.additionalEnv[5].value | string | `"/etc/temporal/tls/tls.key"` |  |
| temporal.server.additionalEnv[6].name | string | `"TEMPORAL_POSTGRES_TLS_ENABLED"` |  |
| temporal.server.additionalEnv[6].value | string | `"true"` |  |
| temporal.server.additionalEnv[7].name | string | `"TEMPORAL_POSTGRES_TLS_DISABLE_HOST_VERIFICATION"` |  |
| temporal.server.additionalEnv[7].value | string | `"true"` |  |
| temporal.server.additionalEnv[8].name | string | `"TEMPORAL_SQL_TLS_ENABLED"` |  |
| temporal.server.additionalEnv[8].value | string | `"true"` |  |
| temporal.server.additionalEnv[9].name | string | `"TEMPORAL_SQL_TLS_DISABLE_HOST_VERIFICATION"` |  |
| temporal.server.additionalEnv[9].value | string | `"true"` |  |
| temporal.server.additionalEnv[10].name | string | `"PG_TLS_CERT_FILE"` |  |
| temporal.server.additionalEnv[10].value | string | `"/etc/temporal/tls/tls.crt"` |  |
| temporal.server.additionalEnv[11].name | string | `"PG_TLS_KEY_FILE"` |  |
| temporal.server.additionalEnv[11].value | string | `"/etc/temporal/tls/tls.key"` |  |
| temporal.server.additionalEnv[12].name | string | `"PG_TLS_ENABLED"` |  |
| temporal.server.additionalEnv[12].value | string | `"true"` |  |
| temporal.server.additionalEnv[13].name | string | `"PG_TLS_DISABLE_HOST_VERIFICATION"` |  |
| temporal.server.additionalEnv[13].value | string | `"true"` |  |
| temporal.server.additionalEnv[14].name | string | `"POSTGRES_TLS_CERT_FILE"` |  |
| temporal.server.additionalEnv[14].value | string | `"/etc/temporal/tls/tls.crt"` |  |
| temporal.server.additionalEnv[15].name | string | `"POSTGRES_TLS_KEY_FILE"` |  |
| temporal.server.additionalEnv[15].value | string | `"/etc/temporal/tls/tls.key"` |  |
| temporal.server.additionalEnv[16].name | string | `"POSTGRES_TLS_ENABLED"` |  |
| temporal.server.additionalEnv[16].value | string | `"true"` |  |
| temporal.server.additionalEnv[17].name | string | `"POSTGRES_TLS_DISABLE_HOST_VERIFICATION"` |  |
| temporal.server.additionalEnv[17].value | string | `"true"` |  |
| temporal.server.additionalEnv[18].name | string | `"SQL_TLS_ENABLED"` |  |
| temporal.server.additionalEnv[18].value | string | `"true"` |  |
| temporal.server.additionalEnv[19].name | string | `"SQL_TLS_DISABLE_HOST_VERIFICATION"` |  |
