...
| postgresql.tls | object | `{"certKeyFilename":"fwinsights-postgresql","certificatesSecret":"fwinsights-postgresql-ca","enabled":true}` | TLS mode for connecting to the database |
