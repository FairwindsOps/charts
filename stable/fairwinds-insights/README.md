...
| temporal.server.additionalEnv[2].name | string | `"SQL_CERT"` |  |
| temporal.server.additionalEnv[2].value | string | `"/etc/temporal/tls/tls.crt"` |  |
| temporal.server.additionalEnv[3].name | string | `"SQL_CERT_KEY"` |  |
| temporal.server.additionalEnv[3].value | string | `"/etc/temporal/tls/tls.key"` |  |
| temporal.server.additionalEnv[4].name | string | `"SQL_HOST_VERIFICATION"` |  |
| temporal.server.additionalEnv[4].value | string | `"false"` |  |
...
| temporal.server.additionalEnv[7].name | string | `"TEMPORAL_SQL_CERT"` |  |
| temporal.server.additionalEnv[7].value | string | `"/etc/temporal/tls/tls.crt"` |  |
| temporal.server.additionalEnv[8].name | string | `"TEMPORAL_SQL_CERT_KEY"` |  |
| temporal.server.additionalEnv[8].value | string | `"/etc/temporal/tls/tls.key"` |  |
| temporal.server.additionalEnv[9].name | string | `"TEMPORAL_SQL_HOST_VERIFICATION"` |  |
| temporal.server.additionalEnv[9].value | string | `"false"` |  |
