...
| databaseCleanupCronjob.resources | object | `{"limits":{"cpu":"500m","memory":"2Gi"},"requests":{"cpu":"80m","memory":"1.5Gi"}}` | Resources for the database cleanup job. |
...
| resourcesRecommendationsCronjob.schedules | list | `[{"cron":"0 0 2 * *","interval":"24h","name":"resources-recommendations"}]` | CRON schedules for the resources recommendations job. |
