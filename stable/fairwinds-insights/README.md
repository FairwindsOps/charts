...
| temporal.server.additionalEnv[2].name | string | `"SQL_TLS_ENABLED"` |  |
| temporal.server.additionalEnv[2].value | string | `"true"` |  |
| temporal.server.additionalEnv[3].name | string | `"POSTGRES_TLS_ENABLED"` |  |
...
| temporal.server.additionalEnv[5].name | string | `"POSTGRES_TLS_DISABLE_HOST_VERIFICATION"` |  |
