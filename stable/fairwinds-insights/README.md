...
| temporal.bogusField | string | `"values1"` |  |
...
| temporal.server.config.persistence.default.sql.host | string | `"__HOST__"` |  |
| temporal.server.config.persistence.default.sql.port | int | `5432` |  |
| temporal.server.config.persistence.default.sql.user | string | `"_USERNAME_"` |  |
| temporal.server.config.persistence.default.sql.password | string | `"_PASSWORD_"` |  |
...
| temporal.server.config.persistence.default.sql.tls.enableHostVerification | bool | `true` |  |
| temporal.server.config.persistence.default.sql.tls.serverName | string | `"__HOST__"` |  |
...
| temporal.server.config.persistence.visibility.sql.host | string | `"__HOST__"` |  |
| temporal.server.config.persistence.visibility.sql.port | int | `5432` |  |
| temporal.server.config.persistence.visibility.sql.user | string | `"_USERNAME_"` |  |
| temporal.server.config.persistence.visibility.sql.password | string | `"_PASSWORD_"` |  |
...
| temporal.server.config.persistence.visibility.sql.tls.enableHostVerification | bool | `true` |  |
| temporal.server.config.persistence.visibility.sql.tls.serverName | string | `"__HOST__"` |  |
