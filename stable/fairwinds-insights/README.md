...
| cronjobs.image-vulns-on-demand-refresh | object | `{"command":"image_vulnerabilities_on_demand_refresher","schedule":"*/2 0 * * *"}` | Options for the image-vulnerabilities-on-demand-refresher |
