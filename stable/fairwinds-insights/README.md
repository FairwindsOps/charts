...
| timescaledb.ephemeral | bool | `false` | Use the ephemeral Timescale chart by default |
| timescaledb.enabled | bool | `false` |  |
| timescaledb.sslMode | string | `"require"` | SSL mode for connecting to the database |
| timescaledb.postgresqlUsername | string | `"postgres"` | Username to connect to Timescale with |
| timescaledb.postgresqlDatabase | string | `"fairwinds_timescale"` | Name of the Postgres Database |
| timescaledb.secrets.certificateSecretName | string | `"fwinsights-timescaledb-ca"` |  |
| timescaledb.secrets.credentialsSecretName | string | `"fwinsights-timescaledb"` |  |
| timescaledb.service.primary | object | `{"port":5433}` | Port of the Timescale Database |
| timescaledb.persistence.enabled | bool | `true` | Create Persistent Volume with Timescale |
| timescaledb.replication.enabled | bool | `false` | Replicate Timescale data |
| timescaledb.loadBalancer.enabled | bool | `false` |  |
| timescaledb.resources.limits.cpu | int | `1` |  |
| timescaledb.resources.limits.memory | string | `"1Gi"` |  |
| timescaledb.resources.requests.cpu | string | `"75m"` |  |
| timescaledb.resources.requests.memory | string | `"256Mi"` |  |
