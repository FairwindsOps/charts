...
| gcpPricing.credentialsSecretName | string | `""` | Existing Secret with the SA JSON. Empty: do not mount (unless externalSecret.create). |
...
| gcpPricing.externalSecret.name | string | `"gcp-pricing-credentials-external"` | ExternalSecret and the Secret it creates. Independent of credentialsSecretName. |
