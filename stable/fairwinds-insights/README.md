...
| temporal.server.additionalEnv[0].name | string | `"SQL_TLS_CERT_FILE"` |  |
| temporal.server.additionalEnv[0].value | string | `"/etc/temporal/tls/tls.crt"` |  |
| temporal.server.additionalEnv[1].name | string | `"TEMPORAL_SQL_TLS_CERT_FILE"` |  |
| temporal.server.additionalEnv[1].value | string | `"/etc/temporal/tls/tls.crt"` |  |
| temporal.server.additionalEnv[2].name | string | `"SQL_TLS_KEY_FILE"` |  |
| temporal.server.additionalEnv[2].value | string | `"/etc/temporal/tls/tls.key"` |  |
| temporal.server.additionalEnv[3].name | string | `"TEMPORAL_SQL_TLS_KEY_FILE"` |  |
| temporal.server.additionalEnv[3].value | string | `"/etc/temporal/tls/tls.key"` |  |
| temporal.server.additionalEnv[4].name | string | `"SQL_TLS"` |  |
...
| temporal.server.additionalEnv[6].name | string | `"SQL_TLS_DISABLE_HOST_VERIFICATION"` |  |
| temporal.server.additionalEnv[6].value | string | `"true"` |  |
| temporal.server.additionalEnv[7].name | string | `"TEMPORAL_SQL_TLS_DISABLE_HOST_VERIFICATION"` |  |
