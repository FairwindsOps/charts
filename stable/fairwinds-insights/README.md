...
| temporal.server.additionalEnv[2].name | string | `"TEMPORAL_SQL_TLS_ENABLED"` |  |
| temporal.server.additionalEnv[2].value | string | `"true"` |  |
| temporal.server.additionalEnv[3].name | string | `"TEMPORAL_POSTGRES_TLS_ENABLED"` |  |
| temporal.server.additionalEnv[3].value | string | `"true"` |  |
| temporal.server.additionalEnv[4].name | string | `"TEMPORAL_SQL_TLS_DISABLE_HOST_VERIFICATION"` |  |
| temporal.server.additionalEnv[4].value | string | `"true"` |  |
| temporal.server.additionalEnv[5].name | string | `"TEMPORAL_POSTGRES_TLS_DISABLE_HOST_VERIFICATION"` |  |
