...
| options.agentChartTargetVersion | string | `"6.13.0"` | Which version of the Insights Agent is supported by this version of Fairwinds Insights |
...
| cronjobExecutor.image.tag | string | `"1.36.4"` |  |
