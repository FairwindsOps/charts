...
| options.agentChartTargetVersion | string | `"5.33.0"` | Which version of the Insights Agent is supported by this version of Fairwinds Insights |
...
| gcpPricing | object | `{"credentialsMountPath":"/var/run/secrets/gcp","credentialsSecretKey":"credentials.json","credentialsSecretName":"gcp-pricing-credentials","credentialsSecretOptional":false,"enabled":false,"externalSecret":{"annotations":{},"create":false,"data":[],"name":"","refreshInterval":"1h","secretStoreRef":{"kind":"ClusterSecretStore","name":"fairwinds-vault-backend"}},"projectID":""}` | GCP Cloud Billing / Compute pricing for UpdateGCPCloudPricingWorkflow (general-worker). Off by default (self-hosted). SaaS sets enabled + projectID and either mounts a Secret or creates an ExternalSecret from Vault; ADC uses GOOGLE_APPLICATION_CREDENTIALS. |
