...
| cloudCostsUpdateCronjob.enabled | bool | `true` | Enable cloud costs update, true by default |
| cloudCostsUpdateCronjob.resources | object | `{"limits":{"cpu":"500m","memory":"1024Mi"},"requests":{"cpu":"80m","memory":"128Mi"}}` | Resources for the cloud costs update job |
| cloudCostsUpdateCronjob.schedules | list | `[{"cron":"0 0 * * *","interval":"24h","name":"cloud-costs-update"}]` | CRON schedules for the cloud costs update job. |
